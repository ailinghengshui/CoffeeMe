...
//                    LogUtil.d("InfiniteViewPager","position:" + position + "->" + FakePositionHelper.getRealPositon(InfiniteViewPager.this, position) + "-return");
...
//                    LogUtil.d("InfiniteViewPager","position:" + position + "->" + FakePositionHelper.getRealPositon(InfiniteViewPager.this, position) );
                }
                if (mOnPageChangeListener != null) {
