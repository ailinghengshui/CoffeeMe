...
public class NumberSeekBar2 extends SeekBar implements SeekBar.OnSeekBarChangeListener {
    ...
    public interface OnSeekBarHintProgressChangeListener {
       String onHintTextChanged(NumberSeekBar2 seekBarHint, float progress);
    }
    ...
    public NumberSeekBar2(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init(context, attrs);
    }

    public NumberSeekBar2(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }
