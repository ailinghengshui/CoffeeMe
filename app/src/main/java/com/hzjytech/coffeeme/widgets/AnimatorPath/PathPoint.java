package com.hzjytech.coffeeme.widgets.AnimatorPath;
...
public class PathPoint {
     ...
     * @param endAngle
     */
    public PathPoint(RectF rectF, float startAngle, float swipeAngle) {
        this.mRectF=rectF;
        this.mStartAngle=startAngle;
        this.mSwipeAngle=swipeAngle;
        this.mOperation=ARC;
    }
    ...
    public static PathPoint arcTo(RectF rectF,float startAngle, float swipeAngle){
        return  new PathPoint(rectF,startAngle,swipeAngle);
    }
