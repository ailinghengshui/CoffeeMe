...
//    private List<String> mImageUrls;
    ...
    private Handler mAutoPlayHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            mCurrentPositon++;
             LogUtil.e("mCurrentPosition",mCurrentPositon+"");
             LogUtil.e("mCurrentPosition2",mCurrentPositon%(mBanners.size())+"");
            mViewPager.setCurrentItem(mCurrentPositon%(mBanners.size()+2));
...
//            mPointContainerBackgroundDrawable=getResources().getDrawable(R.drawable.bg_home_banner);
//            mPointContainerBackgroundDrawable = new ColorDrawable(Color.parseColor("#ff0000"));
//        }
        //添加ViewPager
...
//        }
        LayoutParams pointContainerLp;
//        if(Build.VERSION.SDK_INT >= 21){
//            //设置内边距
//            pointContainerRl.setPadding(0, 7, 0, 0);
//            //设定指示器容器布局及位置
//            pointContainerRl.setBackgroundResource(R.drawable.bg_home_banner);
//            pointContainerLp = new LayoutParams(RMP, DensityUtil.dp2px(getContext(),45));
//        }else{
            //设定指示器容器布局及位置
            pointContainerRl.setBackgroundResource(R.drawable.bg_home_banner_below);
            pointContainerLp = new LayoutParams(RMP, RWP);
//        }
...
//    }
    ...
    public void setImagesUrl(List<Banner> banners) {
        //加载网络图片
        mIsImageUrl = true;
    ...
    private int toRealPosition(int position) {
        ...
        int realPosition;
        if (mIsImageUrl) {
            realPosition = (position-1) % mBanners.size();
            if (realPosition < 0)
                realPosition += mBanners.size();
        } else {
        ...
        public void onPageSelected(int position) {
            ...
            if (mIsImageUrl) {
               // Log.e("position",position+"");
                mCurrentPositon = position % (mBanners.size() + 2);
            } else {
        ...
        public Object instantiateItem(ViewGroup container, final int position) {
            ...
            if (mIsImageUrl) {
                DisplayImageOptions options=new DisplayImageOptions.Builder()
                        ...
                        .build();
                ImageLoader.getInstance().displayImage(mBanners.get(toRealPosition(position)).getImage_url(),imageView,options);
...
//                        .into(imageView);
    ...
    private void addPoints() {
        ...
        ImageView imageView;
        int length = mIsImageUrl ? mBanners.size() : mImages.size();
