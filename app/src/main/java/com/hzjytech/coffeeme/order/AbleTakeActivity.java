...
private TitleBar titleBar;
   ...
   //重新扫描二维码
    private void reScan() {
        TitleButtonsDialog descCenterDialog = TitleButtonsDialog.newInstance("二维码已过期，请重新扫一扫", "关闭", "扫一扫");
    ...
    private class AbleTackOrderItemAdapter extends RecyclerView.Adapter<AbleTackOrderItemAdapter.ViewHolder> {
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View inflate = LayoutInflater.from(AbleTakeActivity.this).inflate(R.layout.fragment_order_item_detail, parent, false);
        ...
        class ViewHolder extends RecyclerView.ViewHolder{
            ...
            private  TextView tvOrderitemdetailMore;
    ...
    private void getCoffeeMId(String id,int pos) {
        ...
        map.put(Configurations.VMID, id);
            ...
            entity.addParameter(Configurations.ORDERID, orders.get(pos).getIdentifier());
            map.put(Configurations.ORDERID, orders.get(pos).getIdentifier());
        ...
        x.http().request(HttpMethod.PUT, entity, new Callback.CommonCallback<JSONObject>() {
            ...
            public void onSuccess(JSONObject result) {
                ...
                try {
                    ...
                    }else{ if(result.getInt(Configurations.STATUSCODE)==408){
                        reScan();
                    }
                        ToastUtil.showShort(AbleTakeActivity.this, result.getString(Configurations.STATUSMSG));
