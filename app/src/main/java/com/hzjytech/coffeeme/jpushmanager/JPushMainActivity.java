...
public class JPushMainActivity extends InstrumentedActivity implements View.OnClickListener {
    ...
    private void initView() {
        ...
        String appKey=ExampleUtil.getKeyAppKey(getApplicationContext());
        if(null==appKey) {
            mAppKey.setText("AppKey Error");
        }else{
    ...
    public static final String MESSAGE_RECEIVE_ACTION="com.example.jpush.MESSAGE_RECEIVED_ACTION";
    ...
    public void registerMessageReceiver(){
        ...
        filter.addAction(MESSAGE_RECEIVE_ACTION);
    ...
    public class MessageReceiver extends BroadcastReceiver{
        ...
        public void onReceive(Context context, Intent intent) {
            if(MESSAGE_RECEIVE_ACTION.equals(intent.getAction())){
