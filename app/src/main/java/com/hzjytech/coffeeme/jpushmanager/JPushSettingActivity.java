...
public class JPushSettingActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void setPushTime(){
        ...
        if (startime > endtime) {
            Toast.makeText(JPushSettingActivity.this, "开始时间不能大于结束时间", Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        mEditor.commit();
        Toast.makeText(JPushSettingActivity.this, "设置成功", Toast.LENGTH_SHORT).show();
    }
