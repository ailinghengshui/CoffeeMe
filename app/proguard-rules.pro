...
-keep class com.hzjytech.coffeeme.entities.**{*;}
...
-keep public class com.hzjytech.coffeeme.R$*{
...
#-dontwarn *
#如果爆出warning，在报出warning的包加入类似的语句：-dontwarn 包名
...
-keep class com.hzjytech.coffeeme.me$PointExchangeJsInteration{
   *;
}

-keep class com.hzjytech.coffeeme.me.PointExchangeActivity$PointExchangeJsInteration {
    *;
}
